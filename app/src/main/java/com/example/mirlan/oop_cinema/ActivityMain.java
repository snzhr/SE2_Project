...
import com.example.mirlan.oop_cinema.fragments.FragmentMain;
import com.example.mirlan.oop_cinema.helpers.AppPreferences;
...
import com.example.mirlan.oop_cinema.models.UserAnonymous;
import com.example.mirlan.oop_cinema.models.UserRegistered;
...
//            saveToFirebase(getArray());
    ...
    private ArrayList<Movie> getArray() {
        ...
        movies.add(new Movie("Изгой-один: Звёздные войны. Истории",
                ...
                200));
        movies.add(new Movie("Другой мир: Войны крови",
                "https://st.kp.yandex.net/images/film_iphone/iphone360_840824.jpg",
                "Боевики",
                ...
                210));
        movies.add(new Movie("По соображениям совести",
                "https://www.kinopoisk.ru/images/film_big/649917.jpg",
                "Боевики",
                "Based on the incredible true story", "Медик Американской армии времён Второй Мировой войны Дезмонд Досс, который служил во время битвы за Окинаву, отказывается убивать людей и становится первым идейным уклонистом в американской истории, удостоенным Медали Почёта.",
                220));
