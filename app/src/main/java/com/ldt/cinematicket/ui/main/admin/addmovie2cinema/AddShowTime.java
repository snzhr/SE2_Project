...
/**
 * Spread into a theater and a movie
   * Create a schedule for that movie on that theater
 */
public class AddShowTime extends SupportFragment implements EventListener<QuerySnapshot>, OnSuccessListener<Void>, OnFailureListener, OnCompleteListener<DocumentSnapshot> {
     ...
     * Spread into a theater and a movie
           * Create a schedule for that movie on that theater
           * @param cinema theater needs more movies
           * @param movie movie is added
           * @return Fragment respectively
     */
    ...
    // This function is called to get the number of show time elements
